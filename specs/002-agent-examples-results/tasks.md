...
- [ ] T005 [P] Create example shared test fixture directory in internal/lib/testutil/examples/
...
- [ ] T007 Add run result fields and ToolExecution domain types in internal/agentdserver/domain/agent.go
- [ ] T008 Add runtime migration for run result columns in internal/agentdserver/infra/db/migrations/runtime/004_run_results.sql
- [ ] T009 Add runtime migration for tool executions in internal/agentdserver/infra/db/migrations/runtime/005_tool_executions.sql
- [ ] T010 Update migration coverage for result/tool tables in internal/agentdserver/infra/db/migrations_test.go
- [ ] T011 Extend run repository interfaces for run listing, result persistence, and result lookup in internal/agentdserver/app/ports.go
...
- [ ] T023 [P] [US1] Add example catalog validation test in internal/agentdserver/infra/definition/example_catalog_test.go
- [ ] T024 [P] [US1] Add example README checklist test in internal/agentdserver/infra/definition/example_readme_test.go
- [ ] T025 [P] [US1] Add definition parser fixture tests for local tools, inputs, and network access in internal/agentdserver/infra/definition/parser_test.go
- [ ] T026 [P] [US1] Add example smoke test harness in tests/e2e/examples_smoke_test.go

### Implementation for User Story 1

- [ ] T027 [US1] Delete old flat examples in examples/{ai-product-research.md,daily-pr-review.md,release-notes-helper.md}
...
- [ ] T032 [P] [US1] Create github-trending-engineering-radar definition and README in examples/github-trending-engineering-radar/
...
- [ ] T037 [P] [US1] Add zero-configuration fixture files where required in examples/*/fixtures/
...
- [ ] T042 [P] [US2] Add HTTP contract tests for GET /v1/runs active/all in internal/agentdserver/infra/http/run_query_handler_test.go
