...
- [x] T044 [P] [US2] Add public client tests for ListRuns in pkg/agentdclient/runs_test.go
...
- [x] T052 [US2] Update CLI contract documentation in specs/002-agent-examples-results/contracts/cli.md
...
- [x] T055 [P] [US3] Add HTTP contract tests for GET /v1/agents/{name}/results and GET /v1/runs/{run_id}/result in internal/agentdserver/infra/http/result_handler_test.go
- [x] T056 [P] [US3] Add CLI result command tests for text and JSON output in internal/agentd/app/result_test.go
- [x] T057 [P] [US3] Add public client result tests in pkg/agentdclient/results_test.go
- [x] T058 [P] [US3] Add Bash automation scenario to tests/e2e/result_automation_test.go

### Implementation for User Story 3

- [x] T059 [US3] Persist successful and failed run results from runtime completion in internal/agentdserver/app/runtime/manager.go
...
- [x] T067 [US3] Update OpenAPI results contract in specs/002-agent-examples-results/contracts/openapi.yaml
- [x] T068 [US3] Update public Go client contract in specs/002-agent-examples-results/contracts/public-go-client.md
...
- [x] T071 [P] [US4] Add CLI logs regression test for action logs in internal/agentd/app/logs_test.go
...
- [x] T079 [P] [US5] Add process tool adapter tests for success, non-zero exit, timeout, and env scoping in internal/agentdserver/infra/runtime/tool_process_test.go
- [x] T080 [P] [US5] Add runtime manager tests for declared tool execution in internal/agentdserver/app/runtime/execute_test.go
- [x] T081 [P] [US5] Add isolation test for undeclared tool denial in internal/agentdserver/infra/runtime/manager_test.go
- [x] T082 [P] [US5] Add Linux/macOS platform verification tests for process cancellation in internal/agentdserver/infra/runtime/platform_test.go
...
- [x] T090 [US5] Update example tools to follow CLI stdin/stdout/exit contract in examples/*/tools/
