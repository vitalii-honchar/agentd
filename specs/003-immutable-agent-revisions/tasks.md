...
- [ ] T005 Add revision artifact service file in internal/agentdserver/infra/runtime/revision_artifact.go
...
- [ ] T035 [US1] Add HTTP apply response tests for revision ID, artifact path, revision status, and unchanged reuse in internal/agentdserver/infra/http/apply_handler_test.go
...
- [ ] T046 [P] [US3] Add runtime manager tests proving custom_tool commands execute copied artifact files from execution workdirs in internal/agentdserver/infra/runtime/manager_test.go
