...
- [ ] T018 Add domain validation and state transition tests in internal/agentdserver/domain/agent_test.go
...
- [ ] T025 Create runtime SQLite migration `003_runtime_event_indexes.sql` in internal/agentdserver/infra/db/migrations/runtime/003_runtime_event_indexes.sql
- [ ] T026 Add migration schema tests for settings/runtime DBs in internal/agentdserver/infra/db/migrations_test.go
...
- [ ] T049 [US1] Implement Markdown front matter parser in internal/agentdserver/infra/definition/parser.go
...
- [ ] T076 [US2] Implement execute use case in internal/agentdserver/app/runtime/execute.go
- [ ] T077 [US2] Implement stop use case in internal/agentdserver/app/runtime/stop.go
- [ ] T078 [US2] Implement daemon restart recovery use case in internal/agentdserver/app/runtime/recovery.go
...
- [ ] T107 [P] Add Linux/macOS runtime path and signal behavior tests in internal/agentdserver/infra/runtime/platform_test.go
